Public Class frmSelectProcess
    ...
    Private Sub frmSelectProcess_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        lblProcessSelectStatus.Text = "Select a process.."
    ...
    Private Sub exitOK()
        ...
        If selectedItemRow = -1 Then
            lblProcessSelectStatus.Text = "No process is selected. OK ignored"
            Exit Sub
        End If
    ...
    Private Sub newSelection()
        ...
        lblProcessSelectStatus.Text = "Selected Process: " & getCell(grdProcessCatalog, selectedItemRow, 1)
    End Sub
End Class