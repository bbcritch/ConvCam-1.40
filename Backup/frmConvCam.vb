...
Public Class frmConvCAM
    ...
    Private Sub frmConvCAM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not s.StartSequence Then End
    ...
    Private Sub initGUI()
        ...
        txtURL.Text = GetProgramInfo("WEBSITE")
        brsWeb.Navigate(txtURL.Text)
    ...
    End Sub
    Private Sub LoadProcessToTable()

        sActiveStateList = p.getStateList
        SetTableSize()

        If sActiveStateList.Length = 0 Then Exit Sub
    ...
    Private Sub readGCode()
        ...
        dlgOpen.Reset()
        dlgOpen.InitialDirectory = gPath.addSlash(gPath.basePath) & "My gCode"
    ...
    Private Sub SaveCompositePartFile()
        ...
        sFname = gPath.Path(gPath.partPath, PartFileName & ".txt")
    ...
    Private Sub savePartFile()
        ...
        If Integer.Parse(x.extract(s, "QTY")) > 1 Then
            ...
            dlgSave.Reset()
            dlgSave.InitialDirectory = gPath.addSlash(gPath.basePath) & "My Parts"
            dlgSave.ShowDialog()
            ...
            If dlgSave.FileName <> "" Then
                ...
                '   f.fileWrite(tDir & "\" & "GCODE", gC.makeGCodeAll)
    ...
    Private Sub saveGCode()
        ...
        If txtGcodeBox.Text.Trim <> "" Then
            ...
            dlgSave.Reset()
            dlgSave.InitialDirectory = GCODEDIR
            ...
            End If
        Else
            MsgBox("There is no GCODE to save..", MsgBoxStyle.OkOnly, "No GCODE")
        End If
    ...
    Private Function GcodeVerbosity() As String
        ...
        If TRAINING Then
            GcodeVerbosity = "GCODE TRAIN: On "
        Else
            GcodeVerbosity = "GCODE TRAIN: Off"
        End If
...
#Region "Events"
    ...
    Private Sub removeProcess(Optional ByVal forceRemoval As Boolean = False)
        ...
        If i <> -1 Then   '   TBD if list is not empty
            If MsgBox("Are you sure you want to remove this process?", MsgBoxStyle.OkCancel, "Remove Process") = MsgBoxResult.Cancel Then Exit Sub
            dh.removeProcess(i + 1)
            updateDesignSequence()
            setProcessSelectCursor(i)
        Else
            If Not forceRemoval Then
                MsgBox("There are no processes to remove.", MsgBoxStyle.OkOnly)
            End If
        End If
    End Sub
    ...
    Private Sub btnCancelProcessEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancelProcessEdit.Click
        ...
        If MsgBox("If you cancel, this process will be removed. Are you sure you want to cancel?", MsgBoxStyle.YesNo, "Process Cancel") = MsgBoxResult.Yes Then
            removeProcess(True)
            showPart()
            SetFileMenu("part")
        End If
    ...
    Private Sub WoodToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles WoodToolStripMenuItem.Click
        ...
        ScrollToEndOfToolTable()
    End Sub
    Private Sub ConversationalToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ConversationalToolStripMenuItem.Click
        setInputMode(STEPBYSTEP)
        grpTitle.Visible = False
        UpdateStatusBar()
    End Sub
    Private Sub DataSetsToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataSetsToolStripMenuItem.Click
        setInputMode(TABLEINPUT)
        KickOffProcessInputTable()
        UpdateStatusBar()
    End Sub
...
#End Region
    ...
    Private Sub btnBrsGo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBrsGo.Click
        brsWeb.Navigate(txtURL.Text)
    End Sub

    Private Sub btnBrowseBack_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBrowseBack.Click
        brsWeb.GoBack()
    End Sub

    Private Sub btnBrowseForward_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBrowseForward.Click
        brsWeb.GoForward()
    End Sub
    ...
    Private Sub btnHome_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnHome.Click
        ...
        brsWeb.Navigate(txtURL.Text)
    End Sub
    Private Sub setHomePage()
        txtURL.Text = GetProgramInfo("WEBSITE")
        brsWeb.Navigate(txtURL.Text)
    End Sub
    Private Sub refreshUrlText()
        txtURL.Text = brsWeb.Url.ToString
    End Sub
    ...
    Private Sub brsWeb_DocumentCompleted(ByVal sender As System.Object, ByVal e As System.Windows.Forms.WebBrowserDocumentCompletedEventArgs) Handles brsWeb.DocumentCompleted
        refreshUrlText()
    End Sub
    ...
    Private Sub beginEditProcess()
        ...
        Else
            MsgBox("There are no processes to edit", MsgBoxStyle.OkOnly)
        End If
    ...
    Private Sub btnSeqDn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSeqDn.Click
        ...
        If i = -1 Then
            MsgBox("There are no processes to move down.", MsgBoxStyle.OkOnly)
            Exit Sub
        End If
    ...
    Private Sub btnSeqUp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSeqUp.Click
        ...
        If i = -1 Then
            MsgBox("There are no processes to move up.", MsgBoxStyle.OkOnly)
            Exit Sub
        End If
