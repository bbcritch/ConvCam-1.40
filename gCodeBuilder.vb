Public Class gCodeBuilder
    ...
    Public Function makeGCodeAll() As String
        ...
        makeGCodeAll = makeGCodeHeader() & vbCrLf & t
        makeGCodeAll = makeGCodeAll.Replace("#PARTFILENAME#", PartFileName)
    ...
    Private Sub expandloop(ByVal s() As String, ByRef idx As Integer)
        ...
        ' limit idx, if at end of s().
        idx = endIDX + 1
        If idx > s.Length - 1 Then idx = s.Length - 1
